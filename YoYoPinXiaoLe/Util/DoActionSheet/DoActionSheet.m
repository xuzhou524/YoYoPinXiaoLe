...
- (void)setLabelAttributes:(UILabel *)lb{
    ...
    lb.font = [UIFont fontWithName:@"Helvetica" size:16];
...
- (void)setButtonAttributes:(UIButton *)bt cancel:(BOOL)bCancel{
    ...
    if (bCancel){
        bt.backgroundColor = [UIColor colorWithRed:77/255.0 green:92/255.0 blue:127/255.0 alpha:1];
        bt.titleLabel.font = [UIFont fontWithName:@"Helvetica" size:16];
//        bt.titleLabel.font = [UIFont fontWithName:@"Helvetica" size:16];
...
- (void)showActionSheet{
    ...
    _vActionSheet.backgroundColor = [UIColor whiteColor];
